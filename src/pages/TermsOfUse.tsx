    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="container max-w-3xl py-12">
        <div className="prose prose-sm max-w-none text-foreground">
          ...
          <p className="text-foreground">A Salgado no Prato oferece salgados sob encomenda para eventos, festas e ocasiões especiais. Os pedidos são realizados via WhatsApp e estão sujeitos à disponibilidade.</p>
          ...
          <p className="text-foreground">Todo o conteúdo deste site, incluindo textos, imagens, logotipos e design, é de propriedade da Salgado no Prato e está protegido por leis de propriedade intelectual.</p>

          <h2 className="font-heading text-xl font-bold text-foreground">6. Limitação de responsabilidade</h2>
          <p className="text-foreground">A Salgado no Prato não se responsabiliza por danos indiretos decorrentes do uso deste site ou da indisponibilidade temporária dos serviços.</p>
